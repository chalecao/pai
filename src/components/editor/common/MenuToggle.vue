<template>
  <div class="menu-toggle" v-show="!hidden">
    <div class="menu-toggle__header">
      ...
      <i v-if="showAdd" class="menu-toggle__add" @click="addMenu()">+</i>
      <svgicon
        v-if="isClosed"
        icon="system/expand"
        width="16"
        ...
        @click="toggleMenu()"
      ></svgicon>
      <svgicon v-else icon="system/collapse" width="16" color="#737373" @click="toggleMenu()"></svgicon>
    </div>
    <div
      ref="content"
      class="menu-toggle__content"
