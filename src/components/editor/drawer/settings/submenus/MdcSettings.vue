<template>
  <div>
    ...
    <!-- <menu-toggle menuHeader="Material theme" v-if="external == true">
      <div class="menu">
        <material-theme
          :primary="sty['--mdc-theme-primary']"
    ...
    <menu-toggle menuHeader="Component Props" :hidden="!Object.keys(att).length">
      <div class="menu">
