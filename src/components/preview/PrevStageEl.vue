...
export default {
  ...
  render: function(createElement) {
    ...
    if (elementO.type !== "div" || elementO.type !== "span") {
      if (
        isNaN(elementO.width) &&
        (typeof elementO.right !== "undefined" &&
          elementO.right !== null &&
          elementO.right !== "auto") &&
        (typeof elementO.left !== "undefined" &&
          elementO.left !== null &&
          elementO.left !== "auto")
      ) {
        const hHigh = Math.max(
          parseInt(elementO.left),
          parseInt(elementO.right)
        );
        let left = isNaN(elementO.left) ? elementO.left : elementO.left + "px";
        let right = isNaN(elementO.right)
          ? elementO.right
          : elementO.right + "px";
        styles = {
          ...styles,
    ...
    if (elementO.type === "img") {
      if (
        isNaN(elementO.height) &&
        (typeof elementO.top !== "undefined" &&
          elementO.top !== null &&
          elementO.top !== "auto") &&
        (typeof elementO.bottom !== "undefined" &&
          elementO.bottom !== null &&
          elementO.bottom !== "auto")
      ) {
        const vHigh = Math.max(
          parseInt(elementO.top),
          parseInt(elementO.bottom)
        );
        let top = isNaN(elementO.top) ? elementO.top : elementO.top + "px";
        let bottom = isNaN(elementO.bottom)
          ? elementO.bottom
          : elementO.bottom + "px";
        styles = {
          ...styles,
